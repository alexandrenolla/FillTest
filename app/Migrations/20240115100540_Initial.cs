    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Properties",
                columns: new[] { "Id", "Address", "BedroomQuantity", "BusinessType", "Latitude", "Longitude", "Neighborhood", "Price", "Title" },
                values: new object[,]
                {
                    { 1, "Rodovia Jornalista Maurício Sirotsky Sobrinho, 5145, Jurerê, Florianópolis, Santa Catarina, Brasil", 6, "Aluguel", -27.4483702m, -48.4879555m, "Jurerê Internacional", 50000m, "Mansão Branca" },
                    { 2, "Rodovia Tertuliano Brito Xavier, 3100, Canasvieiras, Florianópolis, Santa Catarina, Brasil", 3, "Venda", -27.4360093m, -48.47891629999999m, "Canasvieiras", 650000m, "Apartamento" },
                    { 3, "Rua dos Tambaquis, Jurerê Internacional, Florianópolis, Santa Catarina, Brasil", 5, "Venda", -27.4381978m, -48.497063m, "Jurerê", 3000000m, "Casa Azul" },
                    { 4, "Rua das Tibiras, Jurerê Internacional, Florianópolis, Santa Catarina, Brasil", 5, "Venda", -27.4431942m, -48.4958667m, "Jurerê", 5000000m, "Mansão Amarela" },
                    { 5, "Rua das Algas, 488, Jurerê Internacional, Florianópolis, Santa Catarina, Brasil", 3, "Aluguel", -27.4440168m, -48.4946392m, "Jurerê", 30000m, "Casa" },
                    { 6, "Rodovia Tertuliano Brito Xavier, 3000, Canasvieiras, Florianópolis, Santa Catarina, Brasil", 3, "Venda", -27.4350784m, -48.478676m, "Canasvieiras", 1000000m, "Casa na praia" }
                });
